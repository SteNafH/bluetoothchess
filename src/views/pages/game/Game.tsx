...
//     private device: BluetoothDevice = new BluetoothDevice(this.props.route.params.device, RNBluetoothClassic);
//
...
//         try {
//             let connection = await this.device.isConnected();
//             console.log(connection);
//             if (!connection) {
//                 await this.addData({
//                     data: `Attempting connection to ${this.props.route.params.device.address}`,
//                     timestamp: new Date(),
//                     type: 'error',
//                 });
//
//                 connection = await this.device.connect({delimiter: '\r'});
//
//                 await this.addData({
...
//             } else {
//                 await this.addData({
//                     data: `Connected to ${this.device.address}`,
//                     timestamp: new Date(),
//                     type: 'error',
//                 });
//             }
...
//         try {
//             if (!disconnected) {
//                 disconnected = await this.device.disconnect();
//             }
//
//             await this.addData({
//                 data: 'Disconnected',
...
//         this.readSubscription = this.device.onDataReceived((data: BluetoothDeviceReadEvent) => this.onReceivedData(data));
//     }
//
...
//             console.log(message);
//
//             await RNBluetoothClassic.writeToDevice(this.device.address, message);
//
//             await this.addData({
//                 timestamp: new Date(),
